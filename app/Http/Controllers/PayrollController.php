...
public function calculatePayrollForAll(Request $request)
{
    ...
    foreach ($all_staffs as $staff) {
        ...
        foreach ($shifts as $shift) {
            ...
            if ($was_absent && !$has_admin_approved_absence) {
                // Skip pay calculation entirely for unapproved absences
                continue;
            }
            ...
            if ($shift->is_overtime) {
                if ($was_absent) {
                    continue; // Skip overtime if absent
                }
                ...
                if ($was_absent) {
                    continue; // Skip regular shift if absent
                }
